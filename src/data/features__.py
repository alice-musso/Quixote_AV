...
def _features_function_words_freq(documents, lang):
    ...
    for text in documents:
        ...
        funct_words_freq = [1000. * freqs[function_word] / nwords for function_word in function_words]
         # è una costante moltiplicativa. Moltiplicare la frequenza per 1000 è una tecnica comune per ottenere 
         #frequenze relative su una scala più grande. Questo può essere utile per enfatizzare le differenze tra le 
